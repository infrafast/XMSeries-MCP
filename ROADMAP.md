...
- [~] speaker-context defaults: generic host `context.speaker` transport plus XMSeries-owned `XMS_SPEAKER_MAP` parsing for first-person monitor/input phrases is implemented on the OR4B4 speaker-context branch; coordinated CI/live acceptance pending;
