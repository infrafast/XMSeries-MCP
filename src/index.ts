...
function rampAction(input: AutomationRampInput): AutomationRampAction {
    ...
    const from = input.fromLevel ?? (input.fromDb === null ? 0 : input.fromDb !== undefined ? dbToFaderLevel(input.fromDb).level : undefined);
    ...
    },
    {
        ...
        inputSchema: {
            ...
            properties: {
                ...
                fromDb: { type: "number", description: "Optional start dB value; use this when the user says 'from/de X dB to/a Y dB'. Values below -87 map to -inf/0.0. Omit to read current live value first.", minimum: -120, maximum: 20 },
                ...
                steps: {
                    ...
                    items: {
                        ...
                        properties: {
                            ...
                            fromDb: { type: "number", minimum: -120, maximum: 20 },
