...
- Never try to resolve "façade", "facade", "main", "LR", or "master" as a bus name. In a source-to-destination phrase, these words mean the source's own main LR path, not a bus send.
